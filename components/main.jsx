    ...
    return (
        <div className="relative flex flex-col justify-center items-center p-6">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center">
                <h1 className='text-[40px] md:text-[90px] font-extrabold uppercase text-center text-red-600'>
                    ¡Hay solución para ti! <br /> Trabajos de amor
                </h1>
                <h2 className='text-[25px] md:text-[50px] text-center text-white font-bold'>
                ...
                >
                    <span className='text-white uppercase text-md md:text-2xl font-extrabold'>Haz click aquí ahora</span>
                ...
                <p className='text-white justify-center text-center font-bold text-[18px] md:text-[35px] max-w-[800px]'>
